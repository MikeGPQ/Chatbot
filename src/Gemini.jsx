...
const searchPropertiesFunctionDeclaration = {
  name: 'searchProperties',
  description: 'Search a property based on the values',
  parameters: {
    type: Type.OBJECT,
    properties: {
      area: {
        type: Type.STRING,
        description: 'The are of the property he user is seeking.',
      },
      budget: {
        type: Type.NUMBER,
      ...
      propertyType: {
        type: Type.STRING,
        description: 'The type of property (either condo or lot) the user is seeking',
      },
    },
    required: ['area', 'budget', 'propertyType'],
  },
};
  ...
  config:
    {
      ...
      tools: [{
        functionDeclarations: [searchPropertiesFunctionDeclaration]
      }],
      systemInstruction:{
        parts:[{
          text: `
